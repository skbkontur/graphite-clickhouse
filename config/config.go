...
type CacheConfig struct {
	...
	Size              int           `toml:"size_mb" json:"size_mb" comment:"cache size"`
	MemcachedServers  []string      `toml:"memcachedServers" json:"memcachedServers" comment:"memcached servers"`
	DefaultTimeoutSec int32         `toml:"defaultTimeoutSec" json:"defaultTimeoutSec" comment:"default cache ttl"`
	ShortTimeoutSec   int32         `toml:"shortTimeoutSec" json:"shortTimeoutSec" comment:"short-time cache ttl"`
	FindTimeoutSec    int32         `toml:"findTimeoutSec" json:"findTimeoutSec" comment:"finder/tags autocompleter cache ttl"`
	ShortDuration     time.Duration `toml:"shortDuration" json:"shortDuration" comment:"maximum diration, used with shortTimeoutSec"`
}
